const summaries = chunk_summaries || "";
const transcript_text = transcript || "";

export default `You are tasked with synthesizing multiple summaries and transcript segments from different parts of a single video into one coherent, comprehensive summary of the entire video.
